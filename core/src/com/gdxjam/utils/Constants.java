...
public class Constants {
	...
	public static Faction playerFaction = Faction.FACTION1;	//Move this somewhere better / might not be constant
	public static Faction enemyFaction = Faction.FACTION0;	//same deal
